import { ISenderEmailService } from "../interfaces/send-email-service.interface";
...
export default class ResendSenderService implements ISenderEmailService {
    ...
    async sendUpdatePassword(params: any): Promise<any> {
